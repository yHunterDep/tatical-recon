...
if echo $* | grep '\-wp-recon' -q;then
        ...
        echo;echo "===== WordPress Vulnerabilities =====";echo
        cat wordpress-subs.nucl | awk '{ print $4 }' | nuclei -t http/vulnerabilities/wordpress/ --silent -c 80 -o wordpress-vulns.nucl
fi
